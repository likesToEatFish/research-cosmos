...
var (
	pattern_Query_Params_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 1, 2, 2, 2, 3}, []string{"test", "mock", "v1", "params"}, "", runtime.AssumeColonVerbOpt(false)))

	pattern_Query_Price_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 0, 2, 1}, []string{"mock", "price"}, "", runtime.AssumeColonVerbOpt(false)))
)
